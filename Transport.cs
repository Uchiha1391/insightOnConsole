...
namespace Insight
{
    ...
    //[Serializable] public class ClientDataReceivedEvent : action<ArraySegment<byte>, int> { }
    ...
    [Serializable]
    public delegate void ClientDataReceivedEvent(ArraySegment<byte> bytes, int i);

    [Serializable]
    public delegate void UnityEventException(Exception e);

    [Serializable]
    public delegate void UnityEventInt(int i);

    [Serializable]
    public delegate void ServerDataReceivedEvent(int j, ArraySegment<byte> bytes, int i);

    [Serializable]
    public delegate void UnityEventIntException(int i, Exception e);
    ...
    public abstract class Transport
    {
        ...
        public ClientDataReceivedEvent OnClientDataReceived = new ClientDataReceivedEvent((delegate { }));

        /// <summary>
        /// Notify subscribers when this client encounters an error communicating with the server
        /// </summary>
        public UnityEventException OnClientError = new UnityEventException((delegate { }));
        ...
        /// </summary>
        public UnityEventInt OnServerConnected = (delegate { });

        /// <summary>
        /// Notify subscribers when this server receives data from the client
        /// </summary>
        // Note: we provide channelId for NetworkDiagnostics.
        public ServerDataReceivedEvent OnServerDataReceived = (delegate { });

        /// <summary>
        /// Notify subscribers when this server has some problem communicating with the client
        /// </summary>
        public UnityEventIntException OnServerError = (delegate { });

        /// <summary>
        /// Notify subscribers when a client disconnects from this server
        /// </summary>
        public UnityEventInt OnServerDisconnected = (delegate { });
